(function(){
  ...
  var css='#singaAiBubble{position:fixed;bottom:84px;right:20px;z-index:9990;width:60px;height:60px;border-radius:50%;background:linear-gradient(135deg,#5b4af0,#4632c4);border:none;cursor:pointer;box-shadow:0 8px 28px rgba(91,74,240,.4);display:flex;align-items:center;justify-content:center;font-size:26px;transition:transform .2s}'
  ...
  +'.sac-ava{width:40px;height:40px;border-radius:12px;background:linear-gradient(135deg,#5b4af0,#5b9fff);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0}'
  ...
  +'.sac-msg.user{background:#5b4af0;color:#fff;align-self:flex-end;border-bottom-right-radius:4px}'
  ...
  +'.sac-chip{background:#fff;border:1px solid #dde8f8;border-radius:16px;padding:6px 12px;font-size:12px;font-weight:600;cursor:pointer;color:#5b4af0}'
  ...
  +'.sac-send{width:42px;height:42px;border-radius:12px;background:#5b4af0;border:none;color:#fff;font-size:18px;cursor:pointer;flex-shrink:0}'
  ...
  async function send(text){
    ...
    }catch(e){typing(false);add('Ошибка связи. Позвоните: <a href="tel:+79281618789" style="color:#5b4af0">8 928 161-87-89</a> или <a href="https://t.me/+79281618789" style="color:#5b4af0">Telegram</a>','bot');}
    loading=false;
  }
